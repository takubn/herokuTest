        ...
        　<?php $max = count($result_name);?>      
          ...
          <?php for($i=0; $i<$max; $i++):?>
            ...
            <div class="display-box">
                ...
                <!-- 編集ボタン -->
                <?php echo "<button class=\"buttonEdit\" id=\"btn$i\" onclick=\"inputColorEdit(pureName$i,contents$i),getId(name$i,contents$i,id$i);\">edit</button>"?>
                
                <!-- 削除ボタン　-->
                <?php echo "<button class=\"buttonDelete\"  onclick=\"inputColorDelete(pureName$i,contents$i),deleteBy(id$i);\">delete</button>"?>
